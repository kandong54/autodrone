...
openssl req -x509 -new -nodes -key localhostCA.key -passin pass:$CA_PASSWORD -config localhostCA.conf -sha256 -days 90 -out localhostCA.pem
...
-out localhost.crt -days 90 -sha256 -extfile localhost.conf -passin pass:$CA_PASSWORD